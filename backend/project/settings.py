...
SECRET_KEY = 'django-insecure-5(7+)-6ls3#)46cy(1!@#(*87ct-js@x337)q9a&7z45s^%a0t'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'db',                 # service name in docker-compose, NOT localhost
        'PORT': '5432',
    }
}
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "cards.authentication.CsrfExemptSessionAuthentication",
    ],
